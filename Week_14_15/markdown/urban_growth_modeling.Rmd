...
path = r'https://services3.arcgis.com/i2dkYWmb4wHvYPda/ArcGIS/rest/services/region_county_clp/FeatureServer/0?f=pjson'
...
reclassMatrix <- 
  matrix(c(
    0,  12, 0, # between 0 to 12 goes to 1
    12, 24, 1,
    24, Inf,0),
  ncol=3, byrow=T)
...
```{r, warning = FALSE, message = FALSE}
developed <- 
  lc_2001 == 21 | lc_2001 == 22 | lc_2001 == 23 | lc_2001 == 24

forest <- 
  lc_2001 == 41 | lc_2001 == 42 | lc_2001 == 43 

farm <- 
  lc_2001 == 81 | lc_2001 == 82 

wetlands <- 
  lc_2001 == 90 | lc_2001 == 95 

otherUndeveloped <- 
  lc_2001 == 52 | lc_2001 == 71 | lc_2001 == 31 
water <- lc_2001 == 11
